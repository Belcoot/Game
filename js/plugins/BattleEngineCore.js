...
//=============================================================================
 /*:
 * @plugindesc Tenga más control sobre el flujo del sistema de batalla
 * con este plugin y altere varios aspectos a su gusto.
 * @author Yanfly Engine Plugins - (Es) v1.23
 *
 * @param ---General---
 * @default
 *
 * @param Action Speed
 * @desc Fórmula usada para la velocidad base de una acción.
 ...
 *
 * @param Escape Ratio
 * @desc Fórmula usada para determinar el acierto de escape.
 ...
 * @desc Animación por defecto usada para ciertas habilidades de 
 * acierto.  Use 0 si no quiere Animación.
 * @default 120
 *
 * @param Physical Animation
 * @desc Animación por defecto usada para habilidades físicas.
 * Use 0 si no quiere Animación.
 * @default 52
 *
 * @param Magical Animation
 * @desc Animación por defecto usada para habilidades mágicas.
 * Use 0 si no quiere Animación.
 * @default 51
 *
 * @param Enemy Attack Animation
 * @desc Esta es la Animación de ataque por defecto usada por
 * enemigos.  Por defecto: 0
 * @default 39
 *
 * @param Reflect Animation
 * @desc La Animación usada cuando los ataques mágicos son 
 * reflejados. Asignada: 42
 * @default 42
 *
 * @param Motion Waiting
 * @desc Ejecutar Animaciones después de realizar una acción o
 * durante? Durante: false, Después: true, Por defecto: false
 * @default false
 *
 ...
 * @desc Esta fórmula determina la posición de casa X del actor.
 * Por defecto: 0
 * @default Graphics.boxWidth / 8 + Graphics.boxWidth / 4 * index
 *
 * @param Front Position Y
 * @desc Esta fórmula determina la posición de casa Y del actor.
 * Por defecto: 0
 ...
 * @desc En vista lateral, cuando una unidad toma daño o esquiva,
 * será retrocedida una cierta distancia en pixeles.
 * @default 12
 *
 * @param Show Shadows
 ...
 * @default true
 *
 * @param ---Damage Popups(Ventanas Emergentes de daño)---
 * @default
 *
 * @param Popup Duration
 * @desc Ajuste el número de fotogramas de los popup que serán 
 * visibles.  Por defecto: 90
 * @default 128
 *
 * @param Newest Popup Bottom
 * @desc Posiciona el popups más reciente en la parte de abajo 
 * del grupo. NO - false     SI - true
 * @default true
 *
 * @param Popup Overlap Rate
 * @desc Al aparecer múltiples popups de daño, se cubren entre sí.
 ...
 * golpes críticos.  Por defecto: 255, 0, 0, 160
 * @default 255, 0, 0, 160
 *
 * @param Critical Duration
 * @desc Cuantos frames el parpadeo va a durar por un crítico.
 * Por defecto: 60
 * @default 60
 *
 * @param ---Tick-Settings(configuración de Tick)---
 * @default
 *
 * @param Timed States
...
* 
 * @param AI Self Turns
 * @desc Establecer AI para basarse en sus propios turnos 
 * individuales?  NO - false     SI - true
 * @default true
 *
 ...
 *
 * @param Window Rows
 * @desc Para las ventanas más bajas, cuantas líneas de items 
 * quieres que las ventanas muestren?
 * @default 4
 *
 * @param Command Window Rows
 * @desc Establece el número de líneas para cada ventana de 
 * comando para ser mostrado.  Por defecto: 4
 * @default 4
 *
 * @param Command Alignment
 * @desc Establece la alineación del texto para los comandos de 
 ...
 *
 * @param Current Max
 * @desc Mostrar todo el valor / máximo actual de HP/MP?
 * NO - false     SI - true     Por defecto: true
 * @default false
 *
 * @param ---Selection Help(selección de Ayuda)---
 * @default
 *
 ...
 * @desc Al seleccionar una selección aleatoria de objetivos.
 * %1 - Grupo objetivo (Aliados o enemigos) %2 - número
 * @default %2 Random %1
 *
 * @param ---Enemy Select(selección de Enemigo)---
 * @default
 *
 * @param Visual Enemy Select
 * @desc Remplace la ventana de selección de enemigo por una más 
 ...
 * @desc Cambia el tamaño de la fuente usada para mostrar los 
 * nombres de los enemigos.  Por defecto: 28
 * @default 20
 *
 * @param Enemy Auto Select
 * @desc Cambia cuál enemigo es automáticamente seleccionado 
 * primero.  IZQUIERDA - 0  DERECHA - this.furthestRight()
 * @default this.furthestRight()
 *
 * @param ---Actor Select(selección de Personaje)---
 * @default
 *
 ...
 * @desc Corta el proceso de línea log base para optimizar la 
 * velocidad en batalla. APAGADO - false  ENCENDIDO - true
 * @default true
 *
 * @param Show Action Text
 * @desc Muestra el texto de toda acción o una versión 
 * simplificada de ella.  SIMPLE - false  COMPLETO - true
 * @default false
 *
 * @param Show State Text
 * @desc Muestra todo el texto en relación a estados.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show Buff Text
 * @desc Muestra todo el texto en relación a buffs.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show Counter Text
 * @desc Muestra todo el texto en relación a contraataques.
 * APAGADO - false     ENCENDIDO - true
 * @default true
 *
 * @param Show Reflect Text
 * @desc Muestra todo el texto en relación a hechizos reflejados.
 * APAGADO - false     ENCENDIDO - true
 * @default true
 *
 * @param Show Substitute Text
 * @desc  Muestra todo el texto en relación a daños sustituido.
 * APAGADO - false     ENCENDIDO - true
 * @default true
 *
 * @param Show Fail Text
 * @desc Muestra todo el texto en relación a ataques fallidos.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show Critical Text
 * @desc Muestra todo el texto en relación a golpes críticos.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 ...
 * @desc Muestra todo el texto en relación a ataques evadidos.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show HP Text
 * @desc Muestra todo el texto en relación a daño de HP o curas.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show MP Text
 * @desc Muestra todo el texto en relación a daño MP o curas.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @param Show TP Text
 * @desc Muestra todo el texto en relación a daño de TP o curas.
 * APAGADO - false     ENCENDIDO - true
 * @default false
 *
 * @help
 ...
 * permitiendo que sea más simplificado cómo los RPG modernos y menos torpe 
 * cómo los RPG antiguos. Esto incluye en escoger que texto va a aparecer en
 * la ventana de log de batalla en la parte superior y cómo este será mostrado.
 *
 * ============================================================================
 * Battle Messages - Mensajes de Batalla
 * ============================================================================
 *
 * Cuando cambia "Términos" y el "Mensajes" que aparece en batalla, insertando
 * el siguiente tag en cualquier lugar del mensaje hará que este se centre en
 * el log de la batalla.
 *
 *   <CENTER>
 *   Este tag debe de estar todo en letras mayúsculas para que la ventana de
 *   log de batalla lo reconozca cómo una instrucción para centrar el mensaje
 *   de texto que se muestra en batalla.
 *
 * ============================================================================
 * Battle Windows - Ventanas de Batalla
 * ============================================================================
 *
 * Hay varias opciones para ajustar las configuraciones de ventanas que se
 * encuentran en el sistema de batalla para hacer una navegación del sistema 
 * de batallas más intuitivo. incluye comenzar las rondas con la ventana de  
 ...
 * ============================================================================
 *
 * El orden de turno de batalla también es fijo. de esta manera, cualquier
 * combatiente que tenga el valor de AGI modificado durante el curso de la
 * batalla reflejara esos cambios durante el turno actual en vez del próximo 
 * turno. el cálculo de velocidad de la acción también puede ser ajustado y  
 * afinado para tener el factor aleatorio de la fórmula donde su cálculo de 
 * velocidad es removido, también, hace que AGI sea realmente un parámetro
 * táctico que vale la pena.
 *
 * Habilidad y articulo Notetag:
 *   <speed: +x>
 *   <speed: -x>
 *   Esto le permite romper el pasado límite del editor de -2000 y 2000 lo que
 *   le permite ajustar la velocidad de sus acciones con más control.
 *   
 * ============================================================================
 * Multiple Hits - Aciertos múltiples 
 * ============================================================================
 * Después de Multi-Aciertos 
 * Las acciones de Multi-aciertos ya no terminara prematuramente si el objetivo 
 * muere en medio de la acción. Esto se hace a través de alternar estados 
 * inmortales. (Immortal State) Para hacer  uso de la función, asegúrese de que 
 * su base de  datos tiene un estado inmortal(Immortal State) en alguna parte. 
 * Si usted no desea utilizar esta función, establezca el parámetro de estado-
 * inmortal ID a 0
 *
 * ============================================================================
 ...
 * ============================================================================
 *
 * Aunque los popups de daños aún pueden parecer con los mismos por defecto de 
 * MV, el proceso en el que estos son creados es ahora diferente para 
 * simplificar el proceso del popup de daño. Antes, los popups solamente  
 * aparecerían uno a la vez con los frames diferentes al mínimo para mostrar.
 * Ahora, cualquier acción que se produce en el mismo frame mostrara todos los 
 * popups en el mismo  frame, haciendo que los popups se muestren más suaves y
 * menos torpes.
 *
 * ============================================================================
 ...
 * ============================================================================
 *
 * Los eventos comunes ahora ocurrirán al final de cada acción
 * independientemente  de si el grupo enemigo está o no vivo. Con un 
 * posicionamiento adecuado de la  etiqueta de acción de secuencia, puedes   
 * hacer un evento común de habilidades que ocurra en medio de una acción,  
 * también. sin embargo, tenga en cuenta que si usted fuerza una acción en 
 * medio  de otra acción, el restante de la lista de secuencia de la primera 
 * acción se tornara nulo y sin efecto a favor de la nueva acción forzada.
 *
 * ============================================================================
 * Casting Animations - Animaciones de Lanzamiento
 * ============================================================================
 *
 * Las Animaciones de lanzamiento ayudan a proporcionar señales visuales al
 * jugador haciéndoles saber cuál combatiente va a realizar la acción o el tipo 
 * de habilidad que será la acción. Este plugin habilita a las habilidades para   
 * tener Animaciones de casting que pueden ser modificadas universalmente o 
 * personalizarse para cada habilidad individual.
 *
 * Tag de Habilidad:
 *   <Cast Animation: x>
 *   Asigna la Animación de lanzamiento de las habilidades para Animación ID x.
 *   establecer x a 0 puede causar que la habilidad no tenga ninguna Animación.
 *
 * ============================================================================
 * Changing Battle Systems - Cambio del Sistema de Batalla
 * ============================================================================
 *
 * Mientras que el jugador no esté en batalla, usted puede cambiar el sistema 
 * de batalla usando el comando de plugin. Con solamente este plugin, solo hay 
 * un sistema de batalla incluido: el sistema de batalla por defecto.
 *
 * Comando de Plugin:
 ...
 * frontview su configuración no muestran contraataques, ataques mágicos 
 * reflejados, o en ningún caso la sustitución de los miembros del grupo. 
 * El Battle Engine Core proporciona a juegos que están usando pequeñas 
 * cantidades de Animaciones la configuración de vista lateral para transmitir
 * información al jugador en un sentido más visual.
 *
 * El reflejo mágicos también mostrara una Animación de reflejo para indicar
 * que el combatiente tiene propiedades de reflejo, Esa Animación puede ser 
 * cambiada en los parámetros, pero a ciertos actores, classes, enemigos, armas, 
 * armaduras, y los estados pueden mostrar un tipo único de Animación para
 * reflejo, si lo prefiere.
 *
 * Tag de Actor, Classe, Enemigo, Arma, Armadura, y estado:
 *   <Reflect Animation ID: x>
 *   Cambia la Animación del reflejo del usuario a x. Esto tendrá prioridad en 
 ...
 * que ciertos actores sean capaces de moverse. Ellos estarán inmóviles por 
 * cualquier razón. Para realizar esto, usted puede usar este tag para prohibir  
 * al combatiente que se mueva.
 *
 * Tag de Actor, Classe, Enemigo, Arma, Armadura, y estado:
 *   <Sprite Cannot Move>
 *   Previene al sprite del combatiente de ser movido. Esto tendrá prioridad en 
 *   el siguiente orden: Actor, Classe, Enemigo, Arma, Armadura, y estado. Si 
 *   un enemigo fuera incapaz de moverse cuando se realiza una acción, se 
 *   mostrara  en blanco cómo se hace normalmente en la vista frontal.
 *
 * ============================================================================
 * Custom Sideview Battler Anchor - Personalización de Anchor Batalla lateral 
 * ============================================================================
 *
 * Combatientes de la vista lateral por lo general se centran en posición 
 ...
 *   <Anchor X: y.z>
 *   <Anchor Y: y.z>
 *   Esto establece la localización del anchor -Anclaje- para los combatientes
 *   de la vista lateral en Y.Z. Por defecto, el anchor X es 0.5 en cuanto que
 *   el anchor Y es 1.0. Si usted desea que el anchor X este un poco más a la  
 *   haga que este a menos de 0.5. y más de 0.5 para hacer que el anchor de X 
 *   izquierda, este un poco más a la derecha. Para aumentar el anchor de Y, 
 *   establezca el número de valor para menos de 1.0. Siga ajustando hasta que  
 *   encuentre la configuración del anchor perfecta.
 *
 * ============================================================================
 * Enemy Attack Animation -  Animación de ataque enemigo
 * ============================================================================
 *
 * Para darle a los enemigos Animaciones de ataque único, usted puede usar esta
 * etiqueta:
 *
 * Enemy Notetag:
 *   <Attack Animation: x>
 *   Remplaza X con el ID de la Animación de batalla que usted desee establecer 
 *   cómo la Animación de ataque por defecto del enemigo.
 *
 * ============================================================================
 * Automatic State Removal Conditions - Condiciones Auto Para Remover estados 
 * ============================================================================
 *
 * Por defecto, el sistema de batalla de RPG Maker MV tiene remover estados
 * automáticamente bajo tres diferentes condiciones: ninguna, fin de acción,
 * fin del turno.
 *
 * Ninguna y Fin del Turno trabajan según lo previsto. Sin embargo, los estados
 * Fin de acción, cómo tal, habían sido eliminados al inicio de la acción del
 * combatiente en vez de al final. Esto se ha cambiado y actualizado para que
 * ocurra solo al final de la acción del combatiente.
 *
 * Ahora se añaden 2 condiciones automáticas más: Action Start (Inicio de
 * acción) y Turn Start (Inicio de Turno). Estos se pueden agregar y 
 * implementar usando la siguiente etiqueta:
 *
 * State Notetags:
 *   <Action Start: x>
 *   <Action Start: x to y>
 *   Esto hará que este estado actualice sus turnos restantes en el inicio de
 *   la acción. X es el número de turnos que durara, Si usted usa X a Y, al
 *   aplicar el estado, el estado se eliminara en un número aleatorio de
 *   turnos de X a Y.
 *
 *   <Turn Start: x>
 *   <Turn Start: x to y>
 *   Esto hará que este estado actualice sus turnos restantes en el turno de
 *   la batalla. X es el número de turnos que durara, Si usted usa X a Y, al
 *   aplicar el estado, el estado se eliminara en un número aleatorio de
 *   turnos de X a Y.  
 *
 * ============================================================================
 ...
 * usar secuencias de acción personalizadas. Las secuencias de acción son 
 * instrucciones básicas para el juego, para la creación de habilidades 
 * personalizadas tanto visual cómo mecánicamente. El Battle Engine Core, sin 
 * embargo, solo se incluirá las acciones de secuencias más básicas por lo que 
 * se incluirá las instrucciones sobre cómo crear secuencias de acciones
 ...
 *
 * versión 1.08:
 * - Fixed a bug where battlers gaining HP/MP in the damage fórmula for
 ...
 *
 * versión 1.05:
 * - Added new target typing: Charácter X, which allows you to select
